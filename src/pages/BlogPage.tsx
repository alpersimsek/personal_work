...
export const BlogPage: React.FC<BlogPageProps> = ({
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col w-full selection:bg-white/20">
      ...
      <main className="flex-1 pt-28 sm:pt-32 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-white/10">
            <div>
              <span className="text-xs uppercase tracking-widest text-white/50 font-medium block mb-2">
                Tuğba Ergüner Şimşek • Yayın Arşivi
              </span>
              <h1 className="serif-font text-4xl sm:text-5xl font-light text-white tracking-tight">
            ...
            <div className="flex items-center gap-3">
              {isAdmin ? (
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-white text-black hover:bg-neutral-200 text-xs font-medium transition-all shadow-md flex items-center gap-2"
                >
                ...
                <button
                  onClick={onOpenLogin}
                  className="px-3.5 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/15 text-xs text-white/70 hover:text-white transition-colors flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10">
          ...
          <div className="relative w-full md:w-80">
            <input
              ...
              className="w-full px-4 py-2.5 pl-10 bg-neutral-900 border border-white/15 rounded-xl text-white placeholder-white/40 text-xs focus:outline-none focus:border-white/40 transition-all shadow-inner"
            />
        ...
        {postsData.totalPages > 1 && (
          <div className="flex items-center justify-center gap-2 mt-14">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs text-white/70 disabled:opacity-30 disabled:pointer-events-none transition-colors"
            >
              Önceki
            </button>
      ...
      <Footer onOpenBooking={onOpenBooking} onOpenLogin={onOpenLogin} />
    </div>
  );
};
